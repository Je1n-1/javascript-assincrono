...
const tagsDisponiveis = ["Front-end", "Programação", "Data Science", "Full-stack", "HTML", "CSS", "JavaScript","Python","Java", "C++", "C#", "PHP", "Ruby", "Swift", "Kotlin", "Go", "Rust", "Dart", "TypeScript", "React", "Angular", "Vue.js"].map(tag => tag.toLowerCase());
